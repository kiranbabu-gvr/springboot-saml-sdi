...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
	...
	public KeyManager keyManager() {
		...
		//update required for prod/uat/sit
		Resource storeFile = loader.getResource("classpath:/saml/sitks.jks");
		String storePass = "sitks";
		Map<String, String> passwords = new HashMap<String, String>();
		passwords.put("sitsp", "sitks");
		String defaultKey = "sitsp";
		return new JKSKeyManager(storeFile, storePass, passwords, defaultKey);
	}

	@Bean
	@Qualifier("idp-ca")
	public ExtendedMetadataDelegate caExtendedMetadataProvider() throws MetadataProviderException {
		ClasspathResource metadata = null;
		try {
			//update required for prod/uat/sit
			metadata = new ClasspathResource("/metadata/SDI-SIT-IdPMetadata.xml");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public CachingMetadataManager metadata() throws MetadataProviderException {
		...
		providers.add(caExtendedMetadataProvider());
	...
	public MetadataGenerator metadataGenerator() {
		...
		//update required for prod/uat/sit
		metadataGenerator.setEntityId("com:kiran:sit:sp");
		metadataGenerator.setExtendedMetadata(extendedMetadata());
		metadataGenerator.setIncludeDiscoveryExtension(false);
		metadataGenerator.setKeyManager(keyManager());
		//update required for prod/uat/sit
		//metadataGenerator.setEntityBaseURL("https://kiran-sit.comnet.com.in/saml-sdi");
